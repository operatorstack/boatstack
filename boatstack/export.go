...
name: %s
description: Use when the user explicitly asks for Boatstack or when work targets an active or current-branch published Boatstack delivery. Do not activate from installation, attachment, saved or approved drafts, repository presence, or repository administration alone.
---
