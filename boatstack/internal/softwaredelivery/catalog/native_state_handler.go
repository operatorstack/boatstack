...
var nativeStateHandlerContracts = map[string]nativeStateHandlerContract{
	...
	"work-package-admit":       standardNative([]EffectID{"work.package.admit"}, ObjectiveScopeBoundExact),
	"work-package-approve":     standardNative([]EffectID{"work.package.approve"}, ObjectiveScopeBoundExact),
