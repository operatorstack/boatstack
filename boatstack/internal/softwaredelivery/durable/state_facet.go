...
var stateFieldFacets = map[string]model.StateFacet{
	...
	"Engagement": model.StateFacetProduct, "Delivery": model.StateFacetProduct, "Workspace": model.StateFacetProduct, "WorkPackage": model.StateFacetProduct, "Plan": model.StateFacetProduct,
	...
	"PlanFingerprint": model.StateFacetProduct, "WorkPackageFingerprint": model.StateFacetProduct, "WorkPackageApprovalFingerprint": model.StateFacetProduct, "ApprovalFingerprint": model.StateFacetProduct,
