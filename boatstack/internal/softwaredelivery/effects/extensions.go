...
func NewExtensionLocalPrepared(repositoryRoot, extensionID string, writes []delivery.ResourceWrite, admission protocol.Admission, transition catalog.Transition) (ports.PreparedEffect, error) {
...
// contract.
func NewFlowLocalPrepared(repositoryRoot, flowID string, writes []delivery.ResourceWrite, admission protocol.Admission, transition catalog.Transition) (ports.PreparedEffect, error) {
...
func newNamespacedLocalPrepared(repositoryRoot, namespace, owner, kind string, writes []delivery.ResourceWrite, admission protocol.Admission, transition catalog.Transition) (ports.PreparedEffect, error) {
	if len(writes) == 0 {
