...
func renderCatalogLocus(transitions []catalog.Transition, safety bool) (string, error) {
	...
	result := locusModel{
		...
		Evidence: []locusEvidence{
			{Path: "boatstack/delivery/control.go", Note: "Compiler combines exact CoreSystem, ProgramRuntime, extension, contract, and ownership declarations into one immutable runtime registry."},
