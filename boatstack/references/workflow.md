...
4. record authorization mode, timestamp, source commit, artifact hashes, and baseline diff/path provenance in plan-lock schema v2, plus approver provenance only for human authorization;
