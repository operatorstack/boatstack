...
That is why context trimming is not automatically an optimization. If removing state increases rework or false acceptance, total cost rises. The canonical runtime references are approximately **12502 estimated tokens**, while host adapters point to one operation at a time.
...
The current moves were derived from the Intelligence Flow benchmark corpus and product-repository studies. The generated source commit is [`1ac8b94231a1489bdc960f43fd573c386735bbfa`](https://github.com/operatorstack/intelligence-flow/tree/1ac8b94231a1489bdc960f43fd573c386735bbfa/labs/12-product-engineering-loop).
